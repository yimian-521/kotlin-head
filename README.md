...
**v0.11.4** — 动态缺分补齐版（2026-07-05 免免 &amp; 望安）

八种父进程治理风格。SceneEngine规则链：7条规则×6维交叉推导覆盖无限场景，HyperNetwork同构。态势简报：军队部署时输出场景诊断。增派双层（主动+被动）统一走动态推导。八种指挥官、八种检测性格、十一种子进程职业、ProcessTendency倾向系统。
