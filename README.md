...
**v0.12.8** — --sim-ui 源码模拟测试 + 分体式沙盒六审修复（2026-07-08 免免 &amp; 望安）
...
| v0.12.8 ✅ | --sim-ui五链路全通+分体式沙盒六审修复(14条bug，免免独杀6条) |
...
| v0.12.8 | --sim-ui五链路全通 + 分体式沙盒六审修复(免免独杀6条) |
