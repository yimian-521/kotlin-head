...
**v1.0.2** — BugDB 真实化：2937条全真实规则 + 双模超预索引 + 178S满分（2026-07-12 免免 &amp; 望安）
> BugDB从5000条(89真+4911凑)→2937条全真实规则。双模超预索引：短代码直接匹配、长代码Trie扫描。预加载≤1μs缓存命中。BugScanner集成BugDB(11→2948条)。178S十条满分(8/8)。int++320命中20/20分类全覆盖。对照手册2937条含修复。
